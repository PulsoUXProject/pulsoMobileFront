...
**[⬇ Descargar APK release firmado](https://github.com/PulsoUXProject/pulsoMobileFront/releases/download/release/app-release.apk)** (ver [Releases](https://github.com/PulsoUXProject/pulsoMobileFront/releases))
